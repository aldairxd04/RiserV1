  ...
  return (
    <div className="bg-gray-100  py-20 sm:py-24 lg:py-32" >
      ...
      <section
          ...
          >
            <div className="grid grid-cols-1 gap-y-20 lg:grid-cols-3 lg:gap-y-0 lg:gap-x-8" id='opciones-contacto'>
              {supportLinks.map((link) => (
                <div key={link.name} className="flex flex-col rounded-2xl bg-white shadow-xl">
                  ...
                  <div className="rounded-bl-2xl rounded-br-2xl bg-blue-gray-50 p-6 md:px-8">
                    <a href={link.to} target="_blank" className="text-base font-medium text-[#001E57] hover:text-[#DC9800]">
                      Comunicate
