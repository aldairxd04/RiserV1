          ...
          <div className="md:pl-14  flex md:flex-row flex-col rounded-lg bg-white ">
            <div className="   md:grid md:grid-cols-2 sm:flex sm:flex-col">
              <div className="  relative px-10 pt-10 pb-8 md:px-8">
                ...
                <Link className="transition duration-500 xs:flex md:inline-flex items-center -ml-1 m-5 px-11 py-3 border border-transparent text-sm font-medium rounded-full 
                ...
                ><p className="xs:text-center sm:text-center">Contacto</p></Link>

                <button className="transition duration-500 md:inline-flex items-center px-11 py-3 border  text-sm font-medium rounded-full 
                ...
                focus:ring-[#2DCCD3] xs:flex xs:w-full xs:justify-center hidden">
              ...
              <div className=" px-10 relative md:hidden pb-5 ">
                ...
                <Link className="transition duration-500 xs:flex inline-flex items-center -ml-1 m-5 px-11 py-3 border border-transparent text-sm font-medium rounded-full 
                          shadow-sm text-slate-900 bg-[#FF6900] hover:bg-[#2DCCD3] focus:outline-none focus:ring-2 focus:ring-offset-2
                          focus:ring-[#2DCCD3]  xs:w-full xs:justify-center"
                ><p className="xs:text-center sm:text-center">Contacto</p></Link>

                <button className="transition duration-500 inline-flex items-center px-11 py-3 border  text-sm font-medium rounded-full 
                shadow-sm text-slate-900 border-[#FF6900] bg-white hover:border-[#2DCCD3] hover:bg-[#2DCCD3] focus:outline-none focus:ring-2 focus:ring-offset-2
