  ...
  return (
    <div className="bg-white lg:h-[600px]  ">
      ...
      <div className="relative bg-[#2D3034] ">
        <div className="relative mx-auto max-w-7xl py-28 px-4  sm:px-6 lg:px-8"></div>
      </div>

      {/* Overlapping cards */}
      <section
        className="  relative z-10 mx-auto -mt-32 max-w-7xl px-4  sm:px-6 lg:px-12 "
        ...
        <div className=" grid grid-rows-1 gap-y-20 lg:grid-cols-1 lg:gap-y-0 lg:gap-x-8 ">
          <div className="md:pl-14 flex md:flex-row flex-col rounded-lg bg-white ">
            <div className=" md:grid md:grid-cols-2 sm:flex sm:flex-col">
              <div className="  relative px-6 pt-10 pb-8 md:px-8">
                ...
                <Link className="transition duration-500 inline-flex items-center -ml-1 m-5 px-11 py-3 border border-transparent text-sm font-medium rounded-full 
