  ...
  return (
    <div className="  bg-[#F3F4F6]  ">
      ...
      <div className="relative bg-white  ">
        <div className="relative mx-auto max-w-7xl px-4  sm:px-6 lg:px-8"></div>
      </div>

      {/* Overlapping cards */}
      <section
        className="  relative z-10 mx-auto max-w-7xl  sm:px-6 lg:px-12 "
        ...
        <div className="flex md:mx-0 mx-8 lg:mt-20 md:flex-row  flex-col bg-cover lg:bg-[url('/assets/risr1.jpg')]">
            <div className="lg:mx-48 md:mx-auto lg:right-32 md:top-20 lg:mr-24 pb-5 bg-gray-100  relative flex-1 md:pl-20 md:pt-10 md:pb-8 md:px-8">
              ...
              <Link to="contacto" className="inline-flex items-center px-11 py-3 border  text-sm font-medium rounded-full 
                      ...
                      focus:ring-[#2DCCD3] transition duration-500 xs:w-full xs:justify-center" 
                      >Contacto</Link>
            </div>
          </div>
        </div>
