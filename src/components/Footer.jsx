const navigation = {
    ...
    servicios: [
      { name: 'Contáctanos', href: '/servicios#contacto' },
      { name: 'Dinamometro', href: '/servicios#dinamometro' },
      { name: 'Brindamos', href: '/servicios#brindamos' },
      { name: 'Productos', href: '/servicios#productos' },
    ],
    contacto: [
      { name: 'Compromiso', href: '/contacto#compromiso' },
      { name: 'WhatsApp', href: '/contacto#opciones-contacto' },
      { name: 'Email', href: '/contacto#opciones-contacto' },
      { name: 'MI', href: '/contacto#opciones-contacto' },
    ],
    social: [
      {
        name: 'Facebook',
  ...
  export default function Footer() {
    return (
      <footer className="bg-[#2D3034]" aria-labelledby="footer-heading">
        <h2 id="footer-heading" className="sr-only">
          Footer
        </h2>
        <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8 items-center flex flex-col">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div className="border border-transparent pl-3 border-l-orange-400">
                  ...
                  <ul role="list" className="mt-4 space-y-4 md:block hidden">
                ...
                <div className="mt-7 md:mt-0 border border-transparent pl-3 border-l-orange-400">
