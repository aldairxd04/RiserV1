...
const CompareSlider = () => {
  return (
    <div className="relative mx-auto max-w-3xl py-20">
      ...
      itemTwo={
        <ReactCompareSliderImage src="http://3.bp.blogspot.com/-GZJ1ee3nnxY/UVIcJb8ip_I/AAAAAAAAATA/ds9LeECgI8c/s1600/IMG_0866%5B1%5D.JPG" srcSet="http://3.bp.blogspot.com/-GZJ1ee3nnxY/UVIcJb8ip_I/AAAAAAAAATA/ds9LeECgI8c/s1600/IMG_0866%5B1%5D.JPG" alt="Image two" />
      }
    />
    </div>
  );
